...
- Prompting, constrained decoding, validation, and row mapping consume the same
  ...
  JSON object and reject prose, Markdown, code fences, unrequested reasoning, or
  any other pre/post output. A bounded dynamic extraction record can use
