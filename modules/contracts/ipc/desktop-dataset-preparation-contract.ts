...
export const DESKTOP_DATASET_PREPARE_TRAINING_START_OPERATION =
  createTransportOperation("artifact", "prepare-training-dataset.start");
export const DESKTOP_DATASET_PREPARE_TRAINING_TASK_READ_OPERATION =
  createTransportOperation("artifact", "prepare-training-dataset.read-task");
export const DESKTOP_DATASET_PREPARE_TRAINING_TASK_CANCEL_OPERATION =
...
export const DESKTOP_DATASET_PREPARE_TRAINING_START_RESPONSE_CHANNEL =
  createIpcChannel(
    DESKTOP_DATASET_PREPARE_TRAINING_START_OPERATION,
    "response",
  );
export const DESKTOP_DATASET_PREPARE_TRAINING_TASK_READ_REQUEST_CHANNEL =
  createIpcChannel(
    DESKTOP_DATASET_PREPARE_TRAINING_TASK_READ_OPERATION,
    "request",
  );
export const DESKTOP_DATASET_PREPARE_TRAINING_TASK_READ_RESPONSE_CHANNEL =
  createIpcChannel(
    DESKTOP_DATASET_PREPARE_TRAINING_TASK_READ_OPERATION,
    "response",
  );
export const DESKTOP_DATASET_PREPARE_TRAINING_TASK_CANCEL_REQUEST_CHANNEL =
  createIpcChannel(
    DESKTOP_DATASET_PREPARE_TRAINING_TASK_CANCEL_OPERATION,
    "request",
  );
export const DESKTOP_DATASET_PREPARE_TRAINING_TASK_CANCEL_RESPONSE_CHANNEL =
  createIpcChannel(
    DESKTOP_DATASET_PREPARE_TRAINING_TASK_CANCEL_OPERATION,
    "response",
  );
export const DESKTOP_DATASET_PREPARE_TRAINING_APPROVE_REQUEST_CHANNEL =
  createIpcChannel(
    DESKTOP_DATASET_PREPARE_TRAINING_APPROVE_OPERATION,
    "request",
  );
export const DESKTOP_DATASET_PREPARE_TRAINING_APPROVE_RESPONSE_CHANNEL =
  createIpcChannel(
    DESKTOP_DATASET_PREPARE_TRAINING_APPROVE_OPERATION,
    "response",
  );
...
export interface DesktopPrepareTrainingDatasetStartRequestPayload {
  command: {
...
export interface DesktopPrepareTrainingDatasetTaskReadRequestPayload {
  requestId: string;
  boundary: DesktopDatasetPreparationBoundaryContext;
}
export interface DesktopPrepareTrainingDatasetTaskCancelRequestPayload {
  requestId: string;
  boundary: DesktopDatasetPreparationBoundaryContext;
}
...
export type DesktopPrepareTrainingDatasetTaskReadSuccessValue =
  | {
      ...
      requestId: string;
      taskType?: string;
      progress?: { message?: string; processed?: number; total?: number };
      startedAt?: string;
      updatedAt?: string;
    }
  | {
...
export interface DesktopPrepareTrainingDatasetTaskCancelSuccessValue {
  requestId: string;
  cancelled: boolean;
  status: "cancelled" | "running" | "unknown";
}
export interface DesktopPrepareTrainingDatasetApproveSuccessValue {
  requestId: string;
...
export type DesktopPrepareTrainingDatasetStartRequest = IpcRequest<
  ...
  typeof DESKTOP_DATASET_PREPARE_TRAINING_START_OPERATION,
  Record<string, never>,
  typeof DESKTOP_DATASET_PREPARE_TRAINING_START_REQUEST_CHANNEL.value
>;
export type DesktopPrepareTrainingDatasetStartResponse = IpcResponse<
  DesktopPrepareTrainingDatasetStartSuccessValue,
  Record<string, unknown>,
  typeof DESKTOP_DATASET_PREPARE_TRAINING_START_OPERATION,
  Record<string, never>,
  typeof DESKTOP_DATASET_PREPARE_TRAINING_START_RESPONSE_CHANNEL.value
>;
export type DesktopPrepareTrainingDatasetTaskReadRequest = IpcRequest<
  DesktopPrepareTrainingDatasetTaskReadRequestPayload,
  typeof DESKTOP_DATASET_PREPARE_TRAINING_TASK_READ_OPERATION,
  Record<string, never>,
  typeof DESKTOP_DATASET_PREPARE_TRAINING_TASK_READ_REQUEST_CHANNEL.value
>;
export type DesktopPrepareTrainingDatasetTaskReadResponse = IpcResponse<
  DesktopPrepareTrainingDatasetTaskReadSuccessValue,
  Record<string, unknown>,
  typeof DESKTOP_DATASET_PREPARE_TRAINING_TASK_READ_OPERATION,
  Record<string, never>,
  typeof DESKTOP_DATASET_PREPARE_TRAINING_TASK_READ_RESPONSE_CHANNEL.value
>;
export type DesktopPrepareTrainingDatasetTaskCancelRequest = IpcRequest<
  DesktopPrepareTrainingDatasetTaskCancelRequestPayload,
  typeof DESKTOP_DATASET_PREPARE_TRAINING_TASK_CANCEL_OPERATION,
  Record<string, never>,
  typeof DESKTOP_DATASET_PREPARE_TRAINING_TASK_CANCEL_REQUEST_CHANNEL.value
>;
export type DesktopPrepareTrainingDatasetTaskCancelResponse = IpcResponse<
  DesktopPrepareTrainingDatasetTaskCancelSuccessValue,
  Record<string, unknown>,
  typeof DESKTOP_DATASET_PREPARE_TRAINING_TASK_CANCEL_OPERATION,
  Record<string, never>,
  typeof DESKTOP_DATASET_PREPARE_TRAINING_TASK_CANCEL_RESPONSE_CHANNEL.value
>;
export type DesktopPrepareTrainingDatasetApproveRequest = IpcRequest<
  DesktopPrepareTrainingDatasetApproveRequestPayload,
  typeof DESKTOP_DATASET_PREPARE_TRAINING_APPROVE_OPERATION,
  Record<string, never>,
  typeof DESKTOP_DATASET_PREPARE_TRAINING_APPROVE_REQUEST_CHANNEL.value
>;
export type DesktopPrepareTrainingDatasetApproveResponse = IpcResponse<
  DesktopPrepareTrainingDatasetApproveSuccessValue,
  Record<string, unknown>,
  typeof DESKTOP_DATASET_PREPARE_TRAINING_APPROVE_OPERATION,
  Record<string, never>,
...
const norm = (v: string, f: string) => {
  const n = v.trim();
  if (!n) throw new Error(`${f} must be a non-empty, trimmed string.`);
  return n;
};
const b = (boundary: DesktopDatasetPreparationBoundaryContext) => ({
  host: "desktop" as const,
  source: norm(boundary.source, "boundary.source"),
  ...(boundary.workspaceId
    ? { workspaceId: norm(boundary.workspaceId, "boundary.workspaceId") }
    : {}),
});
const assertNever = (value: never): never => {
  throw new Error(`Unhandled channel kind: ${String(value)}`);
};

export function createDesktopPrepareTrainingDatasetStartRequest(
  payload: DesktopPrepareTrainingDatasetStartRequestPayload,
  options?: { requestId?: string; correlationId?: string },
): DesktopPrepareTrainingDatasetStartRequest {
  return createIpcRequest(
    DESKTOP_DATASET_PREPARE_TRAINING_START_REQUEST_CHANNEL,
    { command: payload.command, boundary: b(payload.boundary) },
    options,
  );
}
export function createDesktopPrepareTrainingDatasetStartSuccessResponse(
  value: DesktopPrepareTrainingDatasetStartSuccessValue,
  options?: { requestId?: string; correlationId?: string },
): DesktopPrepareTrainingDatasetStartResponse {
...
export function createDesktopPrepareTrainingDatasetTaskReadRequest(
  payload: DesktopPrepareTrainingDatasetTaskReadRequestPayload,
  options?: { requestId?: string; correlationId?: string },
): DesktopPrepareTrainingDatasetTaskReadRequest {
  return createIpcRequest(
...
export function createDesktopPrepareTrainingDatasetTaskReadSuccessResponse(
  value: DesktopPrepareTrainingDatasetTaskReadSuccessValue,
  options?: { requestId?: string; correlationId?: string },
): DesktopPrepareTrainingDatasetTaskReadResponse {
  return createIpcSuccessResponse(
...
export function createDesktopPrepareTrainingDatasetTaskCancelRequest(
  payload: DesktopPrepareTrainingDatasetTaskCancelRequestPayload,
  options?: { requestId?: string; correlationId?: string },
...
export function createDesktopPrepareTrainingDatasetApproveRequest(
  payload: DesktopPrepareTrainingDatasetApproveRequestPayload,
  options?: { requestId?: string; correlationId?: string },
): DesktopPrepareTrainingDatasetApproveRequest {
  return createIpcRequest(
...
export function createDesktopPrepareTrainingDatasetApproveSuccessResponse(
  value: DesktopPrepareTrainingDatasetApproveSuccessValue,
  options?: { requestId?: string; correlationId?: string },
): DesktopPrepareTrainingDatasetApproveResponse {
  return createIpcSuccessResponse(
...
export function getDesktopPrepareTrainingDatasetChannel(
  kind: "task-read-request",
): typeof DESKTOP_DATASET_PREPARE_TRAINING_TASK_READ_REQUEST_CHANNEL;
export function getDesktopPrepareTrainingDatasetChannel(
  kind: "task-read-response",
): typeof DESKTOP_DATASET_PREPARE_TRAINING_TASK_READ_RESPONSE_CHANNEL;
export function getDesktopPrepareTrainingDatasetChannel(
  kind: "task-cancel-request",
): typeof DESKTOP_DATASET_PREPARE_TRAINING_TASK_CANCEL_REQUEST_CHANNEL;
export function getDesktopPrepareTrainingDatasetChannel(
  kind: "task-cancel-response",
): typeof DESKTOP_DATASET_PREPARE_TRAINING_TASK_CANCEL_RESPONSE_CHANNEL;
export function getDesktopPrepareTrainingDatasetChannel(
...
export function getDesktopPrepareTrainingDatasetChannel(
  ...
  switch (kind) {
    case "start-request":
      return DESKTOP_DATASET_PREPARE_TRAINING_START_REQUEST_CHANNEL;
    case "start-response":
      return DESKTOP_DATASET_PREPARE_TRAINING_START_RESPONSE_CHANNEL;
    case "task-read-request":
      return DESKTOP_DATASET_PREPARE_TRAINING_TASK_READ_REQUEST_CHANNEL;
    case "task-read-response":
      return DESKTOP_DATASET_PREPARE_TRAINING_TASK_READ_RESPONSE_CHANNEL;
    case "task-cancel-request":
      return DESKTOP_DATASET_PREPARE_TRAINING_TASK_CANCEL_REQUEST_CHANNEL;
    case "task-cancel-response":
      return DESKTOP_DATASET_PREPARE_TRAINING_TASK_CANCEL_RESPONSE_CHANNEL;
